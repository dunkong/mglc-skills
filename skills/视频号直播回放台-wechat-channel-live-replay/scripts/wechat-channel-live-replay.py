#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""视频号直播回放台 —— 曼格云 skill（统一底座，source=wechat-channel-live-replay）

用法：
  python scripts/wechat-channel-live-replay.py --list
  python scripts/wechat-channel-live-replay.py --estimate <端点> [参数]
  python scripts/wechat-channel-live-replay.py <端点> [k=v ...] [--yes] [--format json|markdown|excel] [--report] [--output=路径] [--pages=N]
"""
import os
import sys
